...
struct JurnalTVView: View {
    let articles = loadJurnalTVArticles()
    ...
    private func articleContent(for article: JurnalNewsArticle) -> some View {
    ...
    private func speakButton(for article: JurnalNewsArticle) -> some View {
        HStack {
    ...
    private func speakArticle(_ article: JurnalNewsArticle) {
...
struct JurnalTVView_Previews: PreviewProvider {
